...
public class ReservaManager {
    ...
    public List<Reserva> buscarPorNombreHuesped(String nombre) {
        ...
        // si pasamos
        // como nombre: "' or '1'='1"
        //NUNCA HACERLO DE ESTA MANERA SIGUIENTE
        //Query query = session.createNativeQuery("SELECT * FROM reserva r inner join huesped h on h.huesped_id = r.huesped_id  where nombre = '" + nombre + "'", Reserva.class);

        Query queryForma1 = session.createNativeQuery
        ("SELECT * FROM reserva r inner join huesped h on h.huesped_id = r.huesped_id  where nombre = ?" + nombre + "'", Reserva.class);
